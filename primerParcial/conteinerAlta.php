                            ...
                            <td width="50%">
                                ...
                                <div id="divFrm" style="height:250px;overflow:auto;margin-top:20px">
                                    <div class="form-group">
                                        <input type="number" name="numero" id="numero" placeholder="Ingrese numero" class="form-control" />
                                    </div>
                                    <div class="form-group">
                                        <input type="text" name="descripcion" id="descripcion" placeholder="Ingrese descripcion" class="form-control" />
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <input type="button" class="btn btn-primary btn-block" onclick="agregarConteiner()" value="Agregar" />
                                    </div>
                                    <input type="hidden" id="hdnArchivoTemp" />
