...
class Conexion{
    ...
    $this->_objetoPDO = new PDO('mysql:host=localhost;dbname=usuarios;charset=utf8', 'root', 'vamolarenga', array(PDO::ATTR_EMULATES_PREPARES => FALSE, PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION));
