...
$app->get('/verificarTokenViejo[/]', function (Request $request, Response $response) {  
    ...
    try{
        //Le paso un token creado con el metodo crearToken y ejecuto este para verificar que luego de 60 segundos, tira una excepcion
        autentificadorJWT::verificarToken("eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpYXQiOjE0OTczMTQ5OTIsImV4cCI6MTQ5NzMxNTA1MiwiZGF0YSI6eyJub21icmUiOiJKdWFuIiwiYXBlbGxpZG8iOiJQZXJleiIsImVkYWQiOjMzfSwiYXBwIjoiYXBpcmVzdGp3dCJ9.7iRM2Jk562GGI_eA48jnE_XE3XxDS2s4LE6vOlrxGwo");
        echo "ok";
    }
    catch(Exception $e){
        echo $e;
...
$app->get('/devolverPayload[/]', function (Request $request, Response $response) {  
    ...
    $newResponse = $response->withJson($payload, 401);
    return $newResponse;
});
