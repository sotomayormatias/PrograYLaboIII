...
class Conexion{
    ...
    private function __construct(){
        $this->_objetoPDO = new PDO('mysql:host=localhost;dbname=productos;charset=utf8', 'root', 'vamolarenga', array(PDO::ATTR_EMULATE_PREPARES => FALSE, PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION));
