    ...
    <div id="formLogin" class="container">
      ...
      <form  class="form-ingreso " onsubmit="validarLogin();return false;">
        ...
        <label for="correo" class="sr-only">Correo electrónico</label>
                <input type="email" id="correo" class="form-control" placeholder="Correo electrónico" required="" autofocus="" value="<?php if(isset($_COOKIE['usuario'])) echo $_COOKIE['usuario']; ?>">
